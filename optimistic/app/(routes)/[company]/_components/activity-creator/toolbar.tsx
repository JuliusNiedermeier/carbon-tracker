...
export const ActivityCreatorToolbar: FC<{ height: number }> = (props) => {
  const { isValidCandidate } = useActivityCreator();
  ...
  return (
    <div className="flex gap-1 items-center h-full bg-white rounded-md border p-1" style={{ height: props.height }}>
      ...
      <Button className="h-full rounded-sm bg-emerald-600 text-emerald-200 gap-2 hover:bg-emerald-700" disabled={!isValidCandidate}>
